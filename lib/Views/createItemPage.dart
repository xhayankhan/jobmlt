...
_fetchCustomerName() async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: isEditing == true ? Text('Update Item') : Text(
            'Create Item'),
        centerTitle: true,
    ...
    return Center(child: Text("${data.error}"));
                  ...
                  return ListView(
                    children: <Widget>[
                        ...
                        child: DropdownButtonFormField(
                          ...
                          items: itemCatList.map((itms) {
                            return new DropdownMenuItem(
                              onTap: () {
                                itemCatController.text = itms["ItemCategoryName"];
                                print(itemCatController.text);
                              },
                              child: new Text(itms["ItemCategoryName"],
                              ),
                        ...
                        child: DropdownButtonFormField(
                          ...
                          items: itemTypList.map((itms) {
                            return new DropdownMenuItem(
                              ...
                              child: new Text(itms["ItemTypeName"],
                              ),
                              value: itms["ID"].toString(),
                            );
                          }).toList(),
                      ...
                      CustomTextField(
                          labelText: 'Item Code', controllers: itemCode),
                      CustomTextField(
                          labelText: 'UPC Code', controllers: upcCode),
                      CustomTextField(
                          labelText: 'Item Name', controllers: itemName),
                      CustomTextField(labelText: 'Item Description',
                          ...
                          children: [
                            Expanded(
                              child: TextFormField(
                                readOnly: true,
                                onTap: () async{
                                  final result = await Get.to(makeBrandList(email: email,CAT: CompanyAuthToken,id: 'Make',filteredBy: '',svalue: '',));
                          ...
                          children: [
                            Expanded(
                              child: TextFormField(
                                readOnly: true,
                                onTap: () async{
                                  final result = await Get.to(makeBrandList(email: email,CAT: CompanyAuthToken,id: 'Brand',filteredBy: 'BRAND',svalue: make.text,));
                          ...
                          children: [
                            Expanded(
                              child: TextFormField(
                                readOnly: true,
                                onTap: () async{
                                  var modelSVal='${brand.text},${make.text}';
                                  print(modelSVal);
                                  final result = await Get.to(makeBrandList(email: email,CAT: CompanyAuthToken,id: 'Model',filteredBy: 'MODEL',svalue: modelSVal.toString(),));
                          ...
                          children: [
                            Expanded(
                              child: TextFormField(
                                readOnly: true,
                                onTap: () async{
                                  final result = await Get.to(makeBrandList(email: email,CAT: CompanyAuthToken,id: 'Capacity',filteredBy: '',svalue: '',));
                          ...
                          children: [
                            Expanded(
                              child: TextFormField(
                                ...
                                readOnly: true,
                                onTap: () async{
                                  final result = await Get.to(makeBrandList(email: email,CAT: CompanyAuthToken,id: 'Carrier',filteredBy: '',svalue: '',));
                          ...
                          children: [
                            Expanded(
                              child: TextFormField(
                                ...
                                readOnly: true,
                                onTap: () async{
                                  final result = await Get.to(makeBrandList(email: email,CAT: CompanyAuthToken,id: 'Color',filteredBy: '',svalue: '',));
                          ...
                          children: [
                            Expanded(
                              child: TextFormField(
                                ...
                                readOnly: true,
                                onTap: () async{
                                  final result = await Get.to(makeBrandList(email: email,CAT: CompanyAuthToken,id: 'Condition',filteredBy: '',svalue: '',));
