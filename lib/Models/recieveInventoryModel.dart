...
class RecieveInventoryModel {
  ...
  factory RecieveInventoryModel.fromJson(Map<String, dynamic> json) => RecieveInventoryModel(
    ...
    poNumber: json["PONumber"]== null ? '' : json["PONumber"],
    ...
    amountDue: json["AmountDue"]== null ? '' : json["AmountDue"],
    ...
    totalAmount: json["TotalAmount"]== null ? '' : json["TotalAmount"],
    poPurchaseOrderId: json["PO_PurchaseOrderID"]== null ? '' : json["PO_PurchaseOrderID"],
    dateTimeCreated: json["DateTimeCreated"]== null ? '' : json["DateTimeCreated"],
    dateTimeModified: json["DateTimeModified"] == null ? '' : json["DateTimeModified"],
    billingStatus: json["BillingStatus"]== null ? false : json["BillingStatus"],
    ...
    isTaxIncluded: json["IsTaxIncluded"]== null ? false : json["IsTaxIncluded"],
    billReceived: json["BillReceived"]== null ? false : json["BillReceived"],
